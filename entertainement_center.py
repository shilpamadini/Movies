...
sweet_home_alabama = media.Movie(
    "Sweet Home Alabama",
    "Romantic comedy of a small town girl from Alabama",
    "https://upload.wikimedia.org/wikipedia/en/thumb/f/fc/Sweet_Home_Alabama_film.jpg/220px-Sweet_Home_Alabama_film.jpg",  # Noqa
    "https://www.youtube.com/watch?v=BM89EgWx_Gs"
    )

beautiful_mind = media.Movie(
    "A Beautiful Mind",
    " An American Biographical film based on the life of John Nash,a Nobel Laureate in economics",  # Noqa
...
gladiator = media.Movie(
    "Gladiator",
    "Story of an army general who becomes gladiator by fate",
...
good_will_hunting = media.Movie(
    "Good Will Hunting",
    "Story of a janitor at MIT who has a genius level IQ",
...
spy_game = media.Movie(
    "Spy Game",
    "Story of an american spy",
    "https://upload.wikimedia.org/wikipedia/en/thumb/6/68/Spy_Game_poster.jpg/220px-Spy_Game_poster.jpg",  # Noqa
    "https://www.youtube.com/watch?v=EH30237stWM"
    )

bone_collector = media.Movie(
    "The Bone Collector",
    "Story of Tetraplegic forensics expert and a patrol cop",
    "https://upload.wikimedia.org/wikipedia/en/thumb/3/31/Bone_collector_poster.jpg/220px-Bone_collector_poster.jpg",  # Noqa
